...
/* VANT */
app.use(Button).use(Row).use(Col).use(Sticky).use(NavBar).use(Loading).use(Form).use(Field).use(CellGroup).use(Picker).use(Area).use(Checkbox).use(Popup).use(Toast);
